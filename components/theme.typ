...
#let page_margin_right = 1.5cm
#let page_margin_top = 1.5cm
#let page_margin_bottom = 1.5cm

/* ---- ---- Espaciado de Bloques (Ritmo Vertical) ---- ---- */
#let section_spacing = 1.0cm  // Espacio entre grandes bloques (Experiencia vs Educación)
#let item_spacing = 0.5cm  // Espacio entre elementos de una lista (Empresa A vs Empresa B)
